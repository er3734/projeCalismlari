...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        int index = text.indexOf("o"); // int degiskene atanabilir. k�c�k o harfi
        System.out.println("index = " + index); // 1 :  ayni karakterden birden fazla var ise ilkini verir.
        ...
        /** lastIndexOf()
         *  String icinde aranan karakter(ler)in sondan itibaren ilk indexini varır
