...
//		System.out.println(numOfWords);
        ...
        Map<String,Integer>ayniKelimeSayisi=new HashMap<>();

        for (String w:strArr
             ) {
            if (!ayniKelimeSayisi.containsKey(w)){
                ayniKelimeSayisi.put(w,1);
            }else {
                ayniKelimeSayisi.put(w, ayniKelimeSayisi.get(w)+1);
            }
        }
        System.out.println(ayniKelimeSayisi);
